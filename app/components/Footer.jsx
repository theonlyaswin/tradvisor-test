...
const Footer = () => {
    return (
        <footer className="foote py-8 mb-11">
            <div className="container mx-auto px-4">
                <div className="flex flex-col items-center space-y-6">
                    <Image src="/Tradvisor-logo.png" width={120} height={120} alt="Tradvisor Logo" className="mb-2"/>
                    
                    <div className="flex items-center space-x-4">
                        <a href="mailto:info@tradvisor.com" className=" transition-colors">
                        ...
                        <a href="tel:+971123456789" className=" transition-colors">
                    ...
                    <p className="text-sm text-center">© {new Date().getFullYear()} Tradvisor. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
