...
const BentoCard = ({
  ...
  <div
    ...
    <div
      ...
      <Icon
        className="h-12 w-12 origin-left transform-gpu grid-card transition-all duration-300 ease-in-out group-hover:scale-75" />
      <h3 className="text-xl font-semibold grid-card">
        {name}
      </h3>
      <p className="max-w-lg grid-card-p">{description}</p>
    </div>
